...
const Hero = () => {
  return (
    <div className='w-full h-screen max-h-[1080px] flex flex-col justify-center items-center cursor-default'>
        ...
        <a href='https://metaverse.hologrart.com/' target='_blank' className='text-white text-2xl cursor-pointer py-3 px-5 border-4 border-purple-700 hover:bg-purple-700/40 transition-all duration-300'>Try Pre-Alfa <OpenInNewIcon /></a>
