...
//     return (
//         <div className='flex flex-col gap-6 items-center p-5 text-black'>
...
const Metaverse = () => {
  return (
    <div className='container max-w-7xl mx-auto text-white py-16 text-black'>
        <h1 className='anton text-6xl text-black'>HOLOGRART METAVERSE:</h1>
        <h1 className='anton text-6xl text-yellow-600/40'>THE FUTURE OF NFTS</h1>

        {/* TODO: Fill content */}
        <div className='grid gap-4 grid-cols-2 mt-12'>
            <p className='h-full text-[24px] w-5/6 mx-auto text-center flex items-center justify-center text-black'>The Hologrart Metaverse is a unique metaverse that brings together art, technology, entertainment and monetization opportunities. We are happy to welcome you in the magical world of the future and the past!</p>
